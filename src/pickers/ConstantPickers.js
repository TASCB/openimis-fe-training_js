...
import {
  ...
  PARTICIPANT_TYPE_LIST, ATTENDANCE_STATUS_LIST, EVIDENCE_TYPE_LIST,
} from '../constants';
...
export const ParticipantTypePicker = makePicker('training.participantType', PARTICIPANT_TYPE_LIST);
